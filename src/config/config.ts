...
const MODMAIL_REMINDER_WAIT_TIME_SECONDS = parseInt(process.env.MODMAIL_REMINDER_WAIT_TIME_SECONDS||'30');
...
export {BOT_TOKEN, CLIENT_ID, GUILD_ID, CLIENT_SECRET, MONGO_URI, JWT_SECRET, FRONTEND_URL, DEFAULT_PREFIX, DROP_LOG_CHANNEL_ID, MODMAIL_REMINDER_WAIT_TIME_SECONDS};