...
const PUBLIC_CONFESSIONS_CHANNEL_ID = process.env.PUBLIC_CONFESSIONS_CHANNEL_ID as string;
const CONFESSION_LOGS_CHANNEL_ID = process.env.CONFESSION_LOGS_CHANNEL_ID as string;
...
if (!PUBLIC_CONFESSIONS_CHANNEL_ID) {
  throw new Error("PUBLIC_CONFESSIONS_CHANNEL_ID is not defined");
}

if (!CONFESSION_LOGS_CHANNEL_ID) {
  throw new Error("CONFESSION_LOGS_CHANNEL_ID is not defined");
}
